...
Handelsübliche Modelle im 2.4GHz- und 5GHz-Band \pause
\vfill
Für den Heimbedarf oder kleinere öffentliche Bereiche: \pause
\begin{itemize}
...
Größere Inneninstallationen: \pause
\begin{itemize}
...
Freifunk bietet für viele Anwendungsfelder eine kosteneffiziente Möglichkeit, freien Netzzugang anzubieten:\pause \newline
\begin{itemize}
	\item öffentliche Plätze, Staatstheater, Haltestellen, Krankenhäuser \pause
	\item Hotels, Gaststätten, öffentliche Einrichtungen \pause
	\item Parks (z.B. Herrengarten, Prinz-Emil-Garten) \pause
	\item private Wohnungen, Studentenwohnheime \pause
