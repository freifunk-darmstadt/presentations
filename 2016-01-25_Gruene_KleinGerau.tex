...
\date{\footnotesize 25. Januar 2016}
...
\begin{frame}
	...
	\large \textbf{Teil einer weltweiten Bewegung für \emph{freie} Netze.}\\
	\pause
	\vfill
	\centering
	\includegraphics[scale=0.3]{images/2015-10_freifunk-map}
	\itemize{
	\item{Aufbau in Eigenenergie: Bildungs- und Forschungsnetz}
	\item{Demokratisierung des Netzzugangs}
	\item{aktuell 214 registrierte Freifunk Gruppen}
	\item{bundesweit 26350 offene Zugangspunkte \tiny{Quelle: freifunk-karte.de}}
	\item{DE: Freifunk, AT: Funkfeuer, CH: Openwireless}
	}
...
\begin{frame}{Stand Januar 2016}
	\begin{center}
		...
		\begin{center}
			\only<1>{\includegraphics[height=6.5cm]{images/map_ffda-20160125}}
			\only<2>{\includegraphics[height=6.5cm]{images/map_ffda-detail3-20160125}}
		\end{center}
...
\begin{frame}{1.x Jahre FFDA-Netz}
	...
	\end{itemize}
	\begin{center}
		\only<1>{\includegraphics[width=0.8\textwidth]{images/ffda-Okt14-15}}
		\only<3>{\includegraphics[width=0.8\textwidth]{images/current-nodes}}
